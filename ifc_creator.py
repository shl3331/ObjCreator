...
def moveElementProxy(ifcBuildingElementProxy,locationList):
    ...
    '''
    x=float(locationList[0])
    y=float(locationList[1])
    z=float(locationList[2])
    ifcBuildingElementProxy.ObjectPlacement.RelativePlacement.Location.Coordinates = (x,y,z)
    return ifcBuildingElementProxy
def addObjecttoIfcFile(ifcfile,newFile,info,vertextlst,face_list,mtlList,location,groupName):
    ...
    shapeRepresentation = ifcfile.createIfcShapeRepresentation(subcontext, "Body", "Brep", [shape])
    ...
    for dic in mtlList:
        ...
        rgb2 = ifcfile.createIfcColourRgb(None, dic.get("Kd")[0], dic.get("Kd")[1], dic.get("Kd")[2])
        ...
        styleDrepresentation = ifcfile.createIfcStyledRepresentation(subcontext, None, None, [styledItem])
        material = ifcfile.createIfcMaterial(dic.get("newmtl"), None, None)
    ...
    buildingElementProxy = moveElementProxy(buildingElementProxy, location)
